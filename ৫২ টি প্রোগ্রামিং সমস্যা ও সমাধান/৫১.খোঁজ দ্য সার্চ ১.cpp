...
/*
How many input are you taking = 5
Input :Enter a string and substring: banana ana
Output:1
Input :Enter a string and substring: banana ban
Output:0
Input :Enter a string and substring: aquickbrownfoxjumpsoverthelazydog fox
Output:11
Input :Enter a string and substring: foobar foobar
Output:0
Input :Enter a string and substring: fazley_atif_maruf maruf
Output:12
*/
